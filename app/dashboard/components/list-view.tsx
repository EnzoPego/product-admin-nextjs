    ...
    <div className="block md:hidden">
      {!isLoading &&
        ...
        items.map((item) => (
          <div
            key={item.id}
            className="flex justify-center items-center mb-6 border border-solid border-gray-300 rounded-xl p-6"
          >
            ...
            {/* //Loading */}
          {isLoading && [1,1,1,1,1].map((item, i) => (
